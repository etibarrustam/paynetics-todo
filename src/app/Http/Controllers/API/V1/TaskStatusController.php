...
class TaskStatusController extends Controller
{
    ...
    {
        $this->repository = Repository::make(TaskStatus::class);
    }

    public function all(): ApiResponse
    {
        return $this->successResponse(TaskStatusResourceCollection::make($this->repository->all()));
    }
    ...
    public function getById(int $id): ApiResponse
    {
        ...
        return $this->successResponse(TaskStatusResource::make($task));
    }

    public function store(TaskStatusRequest $request): ApiResponse
    {
        try {
    ...
    public function update(int $id, TaskStatusRequest $request): ApiResponse
    {
        try {
    ...
    public function delete(int $id): ApiResponse
    {
        ...
        return $this->successResponse(TaskStatusResource::make());
    }
}
